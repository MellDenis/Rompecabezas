...
var instrucciones = ["Utiliza las flechas para ir cambiando la posicion del cuadro rosa","Mover la pieza vacia hasta lograr el objetivo","Buena suerte!"];
...
function lastMovimiento(direccion){
